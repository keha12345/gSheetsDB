...
## 💻 Полное руководство по использованию (API Reference)

### 1. Подключение

SDK генерируется динамически. Вам не нужен `npm install`.

```javascript
import { SheetDB } from 'https://script.google.com/macros/s/ВАШ_ID/exec';
